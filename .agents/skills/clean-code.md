...
- Autonomous Modification: Execute code refactors and file adjustments smoothly without splitting changes into interactive confirmation steps. Modify the files directly in place without prompting the user to click "Accept Step" for simple directory modifications.